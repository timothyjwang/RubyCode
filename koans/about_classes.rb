...
class AboutClasses < EdgeCase::Koan
  ...
  def test_args_to_new_must_match_initialize
    ...
    # Previously, .new was called on Dog6, but with an argument that was fed into initial_name.
    # Without an argument, initialize expects an argument but doesn't get one - an ArgumentError is thrown
  end
